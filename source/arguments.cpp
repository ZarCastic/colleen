...
Argument::Argument(std::string arg_name, const uint64_t no_arguments,
    ...
    : _no_arguments(no_arguments),
      _arg_name(std::move(arg_name)),
      _fixed_size(true),
      _option_names(std::move(options)) {}

Argument::Argument(std::string arg_name, const std::string &no_arguments,
                   std::vector<std::string> options) noexcept
    : _no_arguments(Argument::stringToArgNum(no_arguments)),
      _arg_name(std::move(arg_name)),
      _fixed_size(false),
      _option_names(std::move(options)) {
...
Argument::Argument(const std::string &arg_name,
...
const std::string &Argument::argName() const noexcept { return _arg_name; }
