...
uint64_t Colleen::noArgs() const noexcept { return _arguments.size(); }
...
/**** ARG ITERATOR *****/
Colleen::ArgIterator::ArgIterator(const uint64_t idx,
...
uint64_t Colleen::ArgIterator::getIdx() const noexcept { return _idx; }